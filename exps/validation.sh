#!/bin/bash
# test a model to segment abdominal CT/cardiac MRI
GPUID1=0
...
TEST_LABEL=(4 5 7 8 9 10 11 12 14)
###### Training configs ######
NSTEP=30000
DECAY=0.98
...
do
  ...
  do
    ...
    RELOAD_MODEL_PATH="./exps_on_AMOS/CATNet_train_AMOS_cv2/2/snapshots/200000.pth"
